  ...
  public StepCommand createCommand(TaskCommand taskCommand, StepEntity stepEntity) throws InternalException {
    ...
    switch (stepEntity.getOperation()) {
      ...
      case CREATE_KUBERNETES_CLUSTER_SETUP_SLAVES:
        ...
        // hacked by Chaoc
      case CREATE_GRIDENGINE_CLUSTER_INITIATE:
        return new GridengineClusterCreateStepCmd(taskCommand, stepBackend, stepEntity, clusterBackend);
      case CREATE_GRIDENGINE_CLUSTER_SETUP_NFS:
      case CREATE_GRIDENGINE_CLUSTER_SETUP_MASTER:
      case CREATE_GRIDENGINE_CLUSTER_SETUP_SLAVES:
        return new XenonTaskStatusStepCmd(taskCommand, stepBackend, stepEntity,
           new GridengineClusterCreateTaskStatusPoller(taskCommand, clusterBackend, taskBackend));
