...
/**
 * StepCommand that kicks off GridEngine cluster creation.
 */
public class GridengineClusterCreateStepCmd extends StepCommand {
  private static final Logger logger = LoggerFactory.getLogger(GridengineClusterCreateStepCmd.class);
  ...
  public GridengineClusterCreateStepCmd(TaskCommand taskCommand, StepBackend stepBackend,
