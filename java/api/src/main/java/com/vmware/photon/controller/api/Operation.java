...
public enum Operation {
  ...
  // hacked by Chaoc, for creating gridengine clusters
  CREATE_GRIDENGINE_CLUSTER_INITIATE("CreateGridengineClusterInitiate"),
  CREATE_GRIDENGINE_CLUSTER_SETUP_NFS("CreateGridengineClusterSetupNFS"),
  CREATE_GRIDENGINE_CLUSTER_SETUP_MASTER("CreateGridengineClusterSetupMaster"),  
  CREATE_GRIDENGINE_CLUSTER_SETUP_SLAVES("CreateGridengineClusterSetupSlaves"),
