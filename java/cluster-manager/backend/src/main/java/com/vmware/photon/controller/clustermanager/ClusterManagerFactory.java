...
import com.vmware.photon.controller.clustermanager.tasks.GridengineClusterCreateTaskFactoryService; //hacked by chaoc
...
public class ClusterManagerFactory {
   ...
   */
  public static final Class[] FACTORY_SERVICES = { InactiveVmFactoryService.class,
      ClusterDeleteTaskFactoryService.class, ClusterExpandTaskFactoryService.class,
      ClusterMaintenanceTaskFactoryService.class, ClusterResizeTaskFactoryService.class,
      ClusterWaitTaskFactoryService.class, GarbageCollectionTaskFactoryService.class,
      GarbageInspectionTaskFactoryService.class, KubernetesClusterCreateTaskFactoryService.class,
      GridengineClusterCreateTaskFactoryService.class, // hacked by chaoc
      MesosClusterCreateTaskFactoryService.class, SwarmClusterCreateTaskFactoryService.class,
      VmDeprovisionTaskFactoryService.class, VmProvisionTaskFactoryService.class,
  ...
  public ClusterManagerFactory(ListeningExecutorService listeningExecutorService,
      CloseableHttpAsyncClient httpAsyncClient, ServerSet apiFeServerSet, String apiFeSharedSecret,
      ServerSet cloudStoreServerSet, String scriptsDirectory) {
