...
/**
 * This class implements helper routines for calls to the Photon Controller REST
 * API.
 */
public class ApiUtils {
   ...
   *
   * @param task
   *          Supplies a task in the ERROR state.
  ...
  /**
   * This method polls the task status asynchronously until the task completes
   * or fails.
   *
   * @param task
   *          Supplies the task object.
   * @param client
   *          Supplies the API client object.
   * @param service
   *          Supplies the Xenon micro-service which is waiting on the task
   *          completion.
   * @param queryTaskInterval
   *          Supplies the time interval between the task status query.
   * @param callback
   *          Supplies the callback to be invoked when the task completes or
   *          fails.
   */
  ...
  /**
   * This method polls the tasks status asynchronously until all the tasks
   * completes or fails.
   *
   * @param tasks
   *          Supplies a list of task objects.
   * @param client
   *          Supplies the API client object.
   * @param service
   *          Supplies the Xenon micro-service which is waiting on the task
