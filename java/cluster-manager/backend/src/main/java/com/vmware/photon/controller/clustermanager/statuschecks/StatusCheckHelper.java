...
public class StatusCheckHelper {
  ...
  /**
   * Factory method used to create an instance of a StatusChecker corresponding
   * to the passed NodeType.
   *
   * @param service
   *          Reference to the Xenon Service that requires the StatusChecker
   *          instance.
   * @param nodeType
  ...
  public StatusChecker createStatusChecker(Service service, NodeType nodeType) {
    ...
    case GridengineSlave:
      return new GridengineStatusChecker(HostUtils.getGridengineClient(service));
