...
public class ClusterManagerConstants {
  ...
  public static final String EXTENDED_PROPERTY_NFS_IP = "nfs_ip";
  ...
  /**
   * hacked by chaoc. This class defines constant values for Gridengine cluster
   */
  public static class Gridengine {
    public static final int MASTER_COUNT = 1;
    public static final int SSH_PORT = 2049;
    public static final int QMASTER_PORT = 6444;
    public static final int EXECD_PORT = 6445;
  }
