 ...
 * GridengineClusterCreateTaskService instance.
 */
@NoMigrationDuringUpgrade
@NoMigrationDuringDeployment
public class GridengineClusterCreateTask extends ServiceDocument {
  ...
  /**
   * Identifier that will be used to create the Gridengine cluster.
   */
  @DefaultUuid
  @Immutable
  ...
  /**
   * This class defines the state of a GridengineClusterCreateTaskService task.
   */
